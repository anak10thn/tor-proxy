...
var tor = {
  ...
  "stop": function () {
    ...
    tor.id = "ON";
    tor.icon(tor.id);
    tor.log = "Connected to tor.toroo.org:9150";
    app.popup.send("status", {"id": tor.id, "log": tor.log});
    var o = {"mode": "fixed_servers", "rules": {"singleProxy": {"scheme": "socks5", "host": "tor.toroo.org", "port": 9150}}};
...
app.popup.receive("id", function (id) {
  if (id === "install") app.tab.open("https://github.com/anak10thn/toroo/releases");
